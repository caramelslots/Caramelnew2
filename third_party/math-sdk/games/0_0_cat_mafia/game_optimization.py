...
def _basegame_scaling():
    ...
    return ConstructScaling(
        [
            ...
            # Paw was starved to ~0.1% LUT weight — lift hard so opt keeps the fence.
            {"criteria": "paw", "scale_factor": 3.0, "win_range": (1, 8), "probability": 1.0},
            {"criteria": "paw", "scale_factor": 2.2, "win_range": (8, 20), "probability": 1.0},
            {"criteria": "paw", "scale_factor": 1.2, "win_range": (20, 50), "probability": 1.0},
            {"criteria": "sw_expand", "scale_factor": 2.0, "win_range": (1, 10), "probability": 1.0},
            {"criteria": "sw_expand", "scale_factor": 1.5, "win_range": (10, 30), "probability": 1.0},
            {"criteria": "sw_expand", "scale_factor": 0.7, "win_range": (30, 100), "probability": 1.0},
