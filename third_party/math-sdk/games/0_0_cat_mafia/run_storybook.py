"""Storybook-oriented dev sim run для Cat Mafia.

Генерирует МАЛЕНЬКИЙ pool published books (uncompressed .json)
для использования как фикстуры в apps/cat_mafia/src/stories/data/.
...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            # Tiny storybook pools can have zero stddev on a mode — books are still valid.
            print("  (generate_configs skipped: zero stddev on tiny sample)")
    finally:
