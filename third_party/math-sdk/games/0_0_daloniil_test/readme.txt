...
5×5 lines-pay slot, 20 paylines, RTP 96.01%, max win ×25,000.
...
Max win ×25,000 достигается **только через Free Spins** за счёт накопленного
...
за один спин даже на 5×W на всех 20 paylines (5×W = 150×20 = 3000 max).
Wincap = 25000 / max_basegame_win ≈ 9× — нужен FS multiplier ×10+ на длинной
