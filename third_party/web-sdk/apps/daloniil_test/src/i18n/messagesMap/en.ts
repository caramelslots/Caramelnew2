export default {
	...
	GAME_INFO_ABOUT_BODY: 'Wok Fury is a 5-reel, 5-row slot with 25 paylines. Wins are paid from left to right on adjacent reels, starting from the leftmost reel. Only the highest win per line is paid.',
	...
	GAME_INFO_FS_BODY: 'Land 3 Bonus symbols in the base game to trigger Normal Bonus with 10 free spins. Land 4 or more Bonus symbols to trigger Super Bonus with 10 free spins and 1 Sticky Mystery Reel from the start.',
	GAME_INFO_MYSTERY_TITLE: 'STICKY MYSTERY REEL',
	GAME_INFO_MYSTERY_BODY: 'During free spins, collect 4 Bonus symbols to advance one tier on the Progress Ladder. Each tier awards 3 extra free spins and unlocks 1 additional Sticky Mystery Reel. Mystery reels stay in place and reveal the same symbol on every spin.',
	GAME_INFO_BET_MODES_TITLE: 'BET MODES',
	GAME_INFO_BET_MODES_BODY: 'Base mode RTP is 96.01%. Bonus Boost costs 2× the bet and increases the chance of triggering free spins. Special Spins costs 30× the bet. Buy Normal Bonus costs 100× the bet. Buy Super Bonus costs 200× the bet. Maximum win is 2,500× the bet in every bet mode.',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury is a 5-reel, 5-row slot with 25 paylines. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel. Only the highest prize per line is awarded.',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: 'All 25 paylines are always active. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel.',
	...
	GAME_INFO_BET_MODES_BODY_SOCIAL: 'Base mode RTP is 96.01%. Bonus Boost costs 2× the spin and increases the chance of triggering free spins. Special Spins costs 30× the spin. Play Normal Bonus costs 100× the spin. Play Super Bonus costs 200× the spin. Maximum prize is 2,500× the spin in every play mode.',
	GAME_INFO_PAYTABLE_TITLE_SOCIAL: 'PAYTABLE (× SPIN)',
	GAME_INFO_PAYTABLE_NOTE_SOCIAL: 'All payout values are multiples of the total spin.',
