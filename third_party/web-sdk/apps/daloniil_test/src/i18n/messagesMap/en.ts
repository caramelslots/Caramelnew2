export default {
	...
	GAME_INFO_ABOUT_BODY: 'Wok Fury is a 5-reel, 5-row slot with 25 paylines. Wins are paid from left to right on adjacent reels, starting from the leftmost reel. A minimum of 3 matching symbols on a payline is required for a win. Only the highest win per line is paid.',
	...
	GAME_INFO_FS_BODY: 'Land 3 Bonus symbols in the base game to trigger Normal Bonus with 10 free spins. Land 4 Bonus symbols to trigger Super Bonus with 10 free spins and 1 Sticky Mystery Reel from the start. Free spins cannot be retriggered by landing Bonus symbols during the feature. Extra free spins are awarded only through the Progress Ladder.',
	...
	GAME_INFO_PROGRESS_LADDER_BODY: 'During free spins, every Bonus symbol that lands is collected toward the Progress Ladder. Every 4 Bonus symbols collected advance one tier. Each tier awards 3 extra free spins and unlocks 1 additional Sticky Mystery Reel, up to a maximum of 5 tiers (15 extra free spins).',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury is a 5-reel, 5-row slot with 25 paylines. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel. A minimum of 3 matching symbols on a payline is required for a prize. Only the highest prize per line is awarded.',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: 'All 25 paylines are always active. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel. A minimum of 3 matching symbols on adjacent reels is required to create a valid winning line.',
	GAME_INFO_WILD_BODY_SOCIAL: 'The Wild symbol substitutes for all paying symbols except the Bonus symbol. Wild pays 225× spin for 5 of a kind.',
