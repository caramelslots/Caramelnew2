export default {
	...
	GAME_INFO_WILD_BODY: 'The Wild symbol substitutes for all paying symbols except the Bonus symbol. Wild pays 225× bet for 5 of a kind. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_WILD_BODY_SOCIAL: 'The Wild symbol substitutes for all winning symbols except the Bonus symbol. Wild wins 225× play for 5 of a kind. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
