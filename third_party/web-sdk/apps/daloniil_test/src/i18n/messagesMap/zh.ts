export default {
	...
	GAME_INFO_FS_BODY: '在基础游戏中获得 3 个 Bonus 符号可触发含 10 次免费旋转的 Normal Bonus。获得 4 个 Bonus 符号可触发含 10 次免费旋转且从一开始就有 1 个 Sticky Mystery Reel 的 Super Bonus。在功能期间出现 Bonus 符号不会重新触发免费旋转。额外免费旋转仅通过 Progress Ladder 发放。',
