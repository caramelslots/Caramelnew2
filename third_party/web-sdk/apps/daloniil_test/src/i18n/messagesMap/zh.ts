export default {
	...
	GAME_INFO_WILD_BODY: 'Wild 符号可替代除 Bonus 符号外的所有赔付符号。Wild 在 5 连时支付 225× 投注。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury 是一款 5 轴 5 行、25 条中奖线的老虎机。奖励从最左轴开始，在相邻轴上从左到右发放。一条有效中奖线至少需要 3 个相同符号。每条线只发放最高奖励。',
	GAME_INFO_PAYLINES_TITLE_SOCIAL: 'WINLINES (25)',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25 条中奖线始终有效。奖励从最左轴开始，在相邻轴上从左到右发放。一条有效中奖线至少需要相邻轴上 3 个相同符号。',
	GAME_INFO_WILD_BODY_SOCIAL: 'Wild 符号可替代除 Bonus 外的所有付费符号。Wild 在 5 连时支付 225× 旋转。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
