export default {
	...
	GAME_INFO_PROGRESS_LADDER_BODY: '在免费旋转期间，每个落地的 Bonus 符号都会计入 Progress Ladder。每收集 4 个 Bonus 符号提升一级。每级奖励 3 次额外免费旋转并解锁 1 个额外的 Sticky Mystery Reel，最多 5 级（15 次额外免费旋转）。',
