export default {
	...
	GAME_INFO_ABOUT_BODY: 'Wok Fury 是一款 5 转轴 5 行、25 条支付线的老虎机。奖金从最左侧转轴开始，在相邻转轴上从左向右支付。一条有效中奖线至少需要 3 个相同符号。每条线仅支付最高奖金。',
	GAME_INFO_PAYLINES_TITLE: 'PAYLINES (25)',
	GAME_INFO_PAYLINES_NOTE: '25 条支付线始终有效。中奖从最左轴开始，在相邻轴上从左到右支付。一条有效中奖线至少需要相邻轴上 3 个相同符号。',
	...
	GAME_INFO_FS_BODY: '在基础游戏中获得 3 个 Bonus 符号可触发含 10 次免费旋转的 Normal Bonus。获得 4 个或更多 Bonus 符号可触发含 10 次免费旋转且从一开始就有 1 个 Sticky Mystery Reel 的 Super Bonus。在功能期间出现 Bonus 符号不会重新触发免费旋转。额外免费旋转仅通过 Progress Ladder 发放。',
	GAME_INFO_MYSTERY_TITLE: 'STICKY MYSTERY REEL',
	GAME_INFO_MYSTERY_BODY: '在免费旋转期间，每个落地的 Bonus 符号都会计入 Progress Ladder。每收集 4 个 Bonus 符号提升一级。每级奖励 3 次额外免费旋转并解锁 1 个额外的 Sticky Mystery Reel，最多 5 级（15 次额外免费旋转）。Mystery 转轴保持固定，每次旋转显示相同符号。',
	...
	MAX_WIN_SOCIAL: '最大奖励',
	AUTOPLAY_MSG_INSUFFICIENT_FUNDS_BODY_SOCIAL: '请充值或降低旋转金额以继续游戏。',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury 是一款 5 轴 5 行、25 条支付线的老虎机。奖励从最左轴开始，在相邻轴上从左到右发放。一条有效中奖线至少需要 3 个相同符号。每条线只发放最高奖励。',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25 条支付线始终有效。奖励从最左轴开始，在相邻轴上从左到右发放。一条有效中奖线至少需要相邻轴上 3 个相同符号。',
	GAME_INFO_WILD_BODY_SOCIAL: 'Wild 符号可替代除 Bonus 外的所有付费符号。Wild 在 5 连时支付 225× 旋转。',
