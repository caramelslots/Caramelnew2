export default {
	...
	GAME_INFO_LEGAL_BODY: 'العطل يلغي جميع المدفوعات والألعاب. يلزم اتصال إنترنت مستقر. في حال انقطاع الاتصال، أعد تحميل اللعبة لإكمال أي جولات غير مكتملة. يُحسب RTP النظري على مدى عدد كبير من الدورات. حركة البكرات للتوضيح فقط.',
