export default {
	...
	GAME_INFO_WILD_BODY_SOCIAL: 'رمز Wild يستبدل جميع الرموز المدفوعة ما عدا Bonus. Wild يدفع 225× اللفة لـ 5 متطابقة. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
