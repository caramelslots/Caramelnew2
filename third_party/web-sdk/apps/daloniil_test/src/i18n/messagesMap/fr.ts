export default {
	...
	GAME_INFO_WILD_BODY: 'Le symbole Wild remplace tous les symboles payants sauf le symbole Bonus. Wild paie 225× la mise pour 5 identiques. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_WILD_BODY_SOCIAL: 'Le symbole Wild remplace tous les symboles payants sauf Bonus. Wild paie 225× spin pour 5 identiques. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
