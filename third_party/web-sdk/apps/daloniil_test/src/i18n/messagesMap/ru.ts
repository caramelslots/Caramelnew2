export default {
	...
	GAME_INFO_BET_MODES_BODY:
		'RTP базового режима — 96.01%. Bonus Boost стоит 2× ставки и увеличивает шанс запуска фриспинов. Special Spins стоит 30× ставки. Покупка Normal Bonus стоит 100× ставки. Покупка Super Bonus стоит 200× ставки. Максимальный выигрыш — 50 000× ставки в любом режиме.',
	...
	GAME_INFO_LEGAL_BODY:
		'Неисправность аннулирует все выплаты и игры. Требуется стабильное интернет-соединение. При разрыве соединения перезагрузите игру, чтобы завершить незавершённые раунды. Теоретический RTP рассчитывается на большом количестве вращений. Движение барабанов носит иллюстративный характер.',
};
