export default {
	...
	GAME_INFO_WILD_BODY: 'Символ Wild заменяет все оплачиваемые символы, кроме Bonus. Wild платит 225× ставки за 5 одинаковых. Во время фриспинов каждый Wild получает множитель ×2, ×5, ×10, ×20 или ×50. Если на выигрышной линии несколько Wild, их множители складываются и применяются к выплате этой линии.',
	...
	GAME_INFO_WILD_BODY_SOCIAL: 'Символ Wild заменяет все оплачиваемые символы, кроме Bonus. Wild платит 225× спина за 5 одинаковых. Во время фриспинов каждый Wild получает множитель ×2, ×5, ×10, ×20 или ×50. Если на выигрышной линии несколько Wild, их множители складываются и применяются к выплате этой линии.',
