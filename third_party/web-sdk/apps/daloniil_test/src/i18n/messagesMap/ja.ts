export default {
	...
	GAME_INFO_WILD_BODY: 'WildシンボルはBonusシンボルを除くすべての配当シンボルの代わりになります。Wildは5つ揃いで225×ベットを支払います。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Furyは5リール5行25ウィンラインのスロットです。賞は最左リールから隣接リール上で左から右に付与されます。有効な配当ラインには、一致するシンボルが最低3つ必要です。ラインごとに最高賞のみが付与されます。',
	GAME_INFO_PAYLINES_TITLE_SOCIAL: 'WINLINES (25)',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25ウィンラインは常に有効です。賞は最左リールから隣接リール上で左から右に付与されます。有効な配当ラインには、隣接リール上で一致するシンボルが最低3つ必要です。',
	GAME_INFO_WILD_BODY_SOCIAL: 'WildシンボルはBonusを除くすべての配当シンボルの代わりになります。Wildは5一致で225×スピンを払います。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
