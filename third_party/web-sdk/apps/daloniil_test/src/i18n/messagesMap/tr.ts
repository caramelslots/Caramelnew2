export default {
	...
	GAME_INFO_LEGAL_BODY: 'Arıza tüm ödemeleri ve oyunları geçersiz kılar. Kararlı bir internet bağlantısı gereklidir. Bağlantı kesilirse, tamamlanmamış turları bitirmek için oyunu yeniden yükleyin. Teorik RTP birçok dönüş üzerinden hesaplanır. Makara hareketi yalnızca gösterim amaçlıdır.',
