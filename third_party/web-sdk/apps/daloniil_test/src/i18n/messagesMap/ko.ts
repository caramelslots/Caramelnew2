export default {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury는 5릴 5행 25페이라인 슬롯입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 라인당 가장 높은 상금만 지급됩니다.',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25개 페이라인은 항상 활성입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다.',
	...
	GAME_INFO_BET_MODES_BODY_SOCIAL: '기본 모드 RTP는 96.01%입니다. Bonus Boost는 2× 스핀이며 프리 스핀 발동 확률이 증가합니다. Special Spins는 30× 스핀입니다. Normal Bonus 플레이는 100× 스핀, Super Bonus 플레이는 200× 스핀입니다. 최대 상금은 모든 모드에서 2,500× 스핀입니다.',
	GAME_INFO_PAYTABLE_TITLE_SOCIAL: '배당표 (× 스핀)',
	GAME_INFO_PAYTABLE_NOTE_SOCIAL: '모든 배당 값은 총 스핀의 배수입니다.',
