export default {
	...
	GAME_INFO_FS_BODY: '기본 게임에서 Bonus 심볼 3개를 맞추면 10회 무료 스핀이 있는 Normal Bonus가 발동됩니다. Bonus 심볼 4개를 맞추면 10회 무료 스핀과 처음부터 Sticky Mystery Reel 1개가 있는 Super Bonus가 발동됩니다. 기능 중 Bonus 심볼이 나와도 무료 스핀은 재트리거되지 않습니다. 추가 무료 스핀은 Progress Ladder를 통해서만 지급됩니다.',
