export default {
	...
	GAME_INFO_ABOUT_BODY: 'Wok Fury는 5릴 5행, 25개 페이라인 슬롯입니다. 당첨금은 가장 왼쪽 릴부터 인접한 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 일치하는 심볼이 최소 3개 필요합니다. 각 라인에서는 가장 높은 당첨금만 지급됩니다.',
	GAME_INFO_PAYLINES_TITLE: 'PAYLINES (25)',
	GAME_INFO_PAYLINES_NOTE: '25개 페이라인은 항상 활성입니다. 당첨금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 인접 릴에서 일치하는 심볼이 최소 3개 필요합니다.',
	...
	GAME_INFO_FS_BODY: '기본 게임에서 Bonus 심볼 3개를 맞추면 10회 무료 스핀이 있는 Normal Bonus가 발동됩니다. Bonus 심볼 4개 이상을 맞추면 10회 무료 스핀과 처음부터 Sticky Mystery Reel 1개가 있는 Super Bonus가 발동됩니다. 기능 중 Bonus 심볼이 나와도 무료 스핀은 재트리거되지 않습니다. 추가 무료 스핀은 Progress Ladder를 통해서만 지급됩니다.',
	GAME_INFO_MYSTERY_TITLE: 'STICKY MYSTERY REEL',
	GAME_INFO_MYSTERY_BODY: '무료 스핀 중 나온 모든 Bonus 심볼은 Progress Ladder에 수집됩니다. Bonus 심볼 4개를 모을 때마다 한 단계 올라갑니다. 각 단계마다 추가 무료 스핀 3회와 Sticky Mystery Reel 1개가 해제되며, 최대 5단계(추가 무료 스핀 15회)입니다. Mystery 릴은 고정되며 매 스핀마다 같은 심볼을 공개합니다.',
	...
	AUTOPLAY_MSG_INSUFFICIENT_FUNDS_BODY_SOCIAL: '계속하려면 잔액을 충전하거나 스핀 금액을 낮추세요.',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury는 5릴 5행 25페이라인 슬롯입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 일치하는 심볼이 최소 3개 필요합니다. 라인당 가장 높은 상금만 지급됩니다.',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25개 페이라인은 항상 활성입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 인접 릴에서 일치하는 심볼이 최소 3개 필요합니다.',
	GAME_INFO_WILD_BODY_SOCIAL: 'Wild 심볼은 Bonus를 제외한 모든 유료 심볼을 대체합니다. Wild는 5개 일치 시 225× 스핀을 지급합니다.',
