export default {
	...
	GAME_INFO_WILD_BODY: 'Wild 심볼은 Bonus 심볼을 제외한 모든 유료 심볼을 대체합니다. Wild는 5개 일치 시 베팅의 225배를 지급합니다. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury는 5릴 5행 25윈라인 슬롯입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 일치하는 심볼이 최소 3개 필요합니다. 라인당 가장 높은 상금만 지급됩니다.',
	GAME_INFO_PAYLINES_TITLE_SOCIAL: 'WINLINES (25)',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: '25개 윈라인은 항상 활성입니다. 상금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 유효한 당첨 라인을 만들려면 인접 릴에서 일치하는 심볼이 최소 3개 필요합니다.',
	GAME_INFO_WILD_BODY_SOCIAL: 'Wild 심볼은 Bonus를 제외한 모든 유료 심볼을 대체합니다. Wild는 5개 일치 시 225× 스핀을 지급합니다. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
