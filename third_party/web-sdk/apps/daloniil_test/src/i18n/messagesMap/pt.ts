export default {
	...
	GAME_INFO_WILD_BODY: 'O símbolo Wild substitui todos os símbolos pagantes, exceto o símbolo Bonus. Wild paga 225× a aposta por 5 iguais. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_WILD_BODY_SOCIAL: 'O símbolo Wild substitui todos os símbolos pagantes exceto Bonus. Wild paga 225× giro por 5 iguais. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
