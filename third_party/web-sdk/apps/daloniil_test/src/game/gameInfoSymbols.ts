...
export const GAME_INFO_SYMBOL_IMAGES: Record<GameInfoSymbolId, string> = {
	...
	H3: symbolAssetUrl('High_3.webp'),
	H4: symbolAssetUrl('High_4.webp'),
	L1: symbolAssetUrl('Low_1.webp'),
	L2: symbolAssetUrl('Low_2.webp'),
	L3: symbolAssetUrl('Low_3.webp'),
	L4: symbolAssetUrl('Low_4.webp'),
