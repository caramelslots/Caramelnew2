export default {
	...
	GAME_INFO_WILD_BODY:
		'Biểu tượng Wild thay thế mọi biểu tượng trả thưởng trừ biểu tượng Bonus. Wild trả 225× cược cho 5 giống nhau. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_MYSTERY_BODY:
		'Các cuộn Mystery giữ nguyên vị trí và hiển thị cùng một biểu tượng mỗi vòng.',
	GAME_INFO_PROGRESS_LADDER_TITLE: 'PROGRESS LADDER',
	GAME_INFO_PROGRESS_LADDER_BODY:
		'Trong vòng quay miễn phí, mỗi biểu tượng Bonus xuất hiện được thu thập vào Progress Ladder. Cứ 4 biểu tượng Bonus thu thập được sẽ lên một bậc. Mỗi bậc thưởng thêm 3 vòng quay miễn phí và mở khóa 1 Sticky Mystery Reel, tối đa 5 bậc (15 vòng quay miễn phí thêm).',
