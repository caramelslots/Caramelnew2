export default {
	...
	GAME_INFO_PAYLINES_NOTE:
		'جميع خطوط الـ 25 نشطة دائماً. تُدفع الأرباح من اليسار إلى اليمين على البكرات المجاورة، بدءاً من أقصى اليسار. يلزم حد أدنى 3 رموز متطابقة على البكرات المجاورة لإنشاء خط فوز صالح.',
	GAME_INFO_SPECIAL_SYMBOLS_TITLE: 'SPECIAL SYMBOLS',
	GAME_INFO_WILD_TITLE: 'رمز WILD',
	GAME_INFO_WILD_BODY:
		'يحل رمز Wild محل جميع الرموز المدفوعة باستثناء رمز Bonus. يدفع Wild 225× الرهان مقابل 5 من النوع نفسه. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_MYSTERY_BODY:
		'تبقى بكرات Mystery في مكانها وتكشف عن نفس الرمز في كل دورة.',
	GAME_INFO_PROGRESS_LADDER_TITLE: 'PROGRESS LADDER',
	GAME_INFO_PROGRESS_LADDER_BODY:
		'أثناء الدورات المجانية، يُجمع كل رمز Bonus يظهر نحو Progress Ladder. كل 4 رموز Bonus مجمعة ترفع مستوى واحدًا. يمنح كل مستوى 3 دورات مجانية إضافية ويفتح 1 Sticky Mystery Reel إضافي، بحد أقصى 5 مستويات (15 دورة مجانية إضافية).',
