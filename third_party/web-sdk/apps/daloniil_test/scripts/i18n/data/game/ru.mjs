export default {
	...
	GAME_INFO_PAYLINES_NOTE:
		'Все 25 линий всегда активны. Выигрыши считаются слева направо на соседних барабанах, начиная с крайнего левого.',
	...
	GAME_INFO_MYSTERY_BODY:
		'Во время фриспинов собирайте 4 символа Bonus, чтобы подняться на следующий уровень Progress Ladder. Каждый уровень даёт 3 дополнительных фриспина и открывает 1 дополнительный Sticky Mystery Reel. Mystery-барабаны остаются на месте и раскрывают один и тот же символ при каждом вращении.',
