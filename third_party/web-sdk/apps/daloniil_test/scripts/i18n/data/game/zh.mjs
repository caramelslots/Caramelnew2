export default {
	...
	GAME_INFO_WILD_BODY:
		'Wild 符号可替代除 Bonus 符号外的所有赔付符号。Wild 在 5 连时支付 225× 投注。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
