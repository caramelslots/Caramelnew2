export default {
	...
	GAME_INFO_ABOUT_BODY:
		'Wok Fury é um slot de 5 rolos e 5 linhas com 25 linhas de pagamento. Os ganhos são pagos da esquerda para a direita em rolos adjacentes, começando pelo rolo mais à esquerda. É necessário um mínimo de 3 símbolos iguais numa linha de pagamento para um ganho. Apenas o maior ganho por linha é pago.',
	GAME_INFO_PAYLINES_TITLE: 'PAYLINES (25)',
	GAME_INFO_PAYLINES_NOTE:
		'Todas as 25 linhas estão sempre ativas. Os ganhos são pagos da esquerda para a direita em rolos adjacentes, começando no rolo mais à esquerda. É necessário um mínimo de 3 símbolos iguais em rolos adjacentes para criar uma linha vencedora válida.',
	GAME_INFO_SPECIAL_SYMBOLS_TITLE: 'SPECIAL SYMBOLS',
	GAME_INFO_WILD_TITLE: 'SÍMBOLO WILD',
	GAME_INFO_WILD_BODY:
		'O símbolo Wild substitui todos os símbolos pagantes, exceto o símbolo Bonus. Wild paga 225× a aposta por 5 iguais. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_MYSTERY_BODY:
		'Os rolos Mystery permanecem no lugar e revelam o mesmo símbolo em cada rodada.',
	GAME_INFO_PROGRESS_LADDER_TITLE: 'PROGRESS LADDER',
	GAME_INFO_PROGRESS_LADDER_BODY:
		'Durante as rodadas grátis, cada símbolo Bonus que sai é recolhido para a Progress Ladder. A cada 4 símbolos Bonus recolhidos sobe um nível. Cada nível concede 3 rodadas grátis extra e desbloqueia 1 Sticky Mystery Reel adicional, até um máximo de 5 níveis (15 rodadas grátis extra).',
