export default {
	...
	GAME_INFO_WILD_BODY:
		'El símbolo Wild sustituye a todos los símbolos de pago excepto al símbolo Bonus. Wild paga 225× la apuesta por 5 iguales. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
	...
	GAME_INFO_MYSTERY_BODY:
		'Los rodillos Mystery permanecen en su lugar y revelan el mismo símbolo en cada giro.',
	GAME_INFO_PROGRESS_LADDER_TITLE: 'PROGRESS LADDER',
	GAME_INFO_PROGRESS_LADDER_BODY:
		'Durante los giros gratis, cada símbolo Bonus que cae se acumula en la Progress Ladder. Cada 4 símbolos Bonus recogidos suben un nivel. Cada nivel otorga 3 giros gratis extra y desbloquea 1 Sticky Mystery Reel adicional, hasta un máximo de 5 niveles (15 giros gratis extra).',
