export default {
	...
	GAME_INFO_WILD_BODY:
		'WildシンボルはBonusシンボルを除くすべての配当シンボルの代わりになります。Wildは5つ揃いで225×ベットを支払います。 During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning payline, their multipliers are added together and applied to that line win.',
