...
const en = {
	...
	GAME_INFO_WILD_BODY_SOCIAL:
		'The Wild symbol substitutes for all winning symbols except the Bonus symbol. Wild wins 225× play for 5 of a kind. During Free Spins, each Wild receives a multiplier of ×2, ×5, ×10, ×20, or ×50. If more than one Wild lands on a winning winline, their multipliers are added together and applied to that line prize.',
...
const ru = {
	...
	GAME_INFO_WILD_BODY_SOCIAL:
		'Символ Wild заменяет все оплачиваемые символы, кроме Bonus. Wild платит 225× спина за 5 одинаковых. Во время фриспинов каждый Wild получает множитель ×2, ×5, ×10, ×20 или ×50. Если на выигрышной линии несколько Wild, их множители складываются и применяются к выплате этой линии.',
