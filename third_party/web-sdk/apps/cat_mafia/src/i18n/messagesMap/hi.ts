export default {
	...
	GAME_INFO_ABOUT_BODY: 'Meowfia एक 5-रील, 4-पंक्ति स्लॉट है जिसमें 20 पेलाइन्स हैं। जीत बाएँ से दाएँ सAdjacent रीलों पर, सबसे बाएँ रील से शुरू होकर भुगतान होती है। एक लाइन पर जीत के लिए कम से कम 3 मेल खाते सिंबल चाहिए। प्रति लाइन केवल सबसे अधिक जीत भुगतान होती है। बेस गेम में Paw सिक्के और Super Wild एक स्पिन में ट्रिगर हो सकते हैं, लेकिन एक ही स्पिन में दोनों कभी नहीं। 3+ Bonus सिंबल लैंड करें, 8, 10 या 12 फ्री स्पिन के लिए लक्ष्य चुनें।',
