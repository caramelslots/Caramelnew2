export default {
	DUEL_BANK_TOTAL: 'المجموع',
	DUEL_BANK_TOTAL_SOCIAL: 'المجموع',
	HOME: 'الرئيسية',
	GAME_TITLE: 'Meowfia',
	...
	GAME_INFO_ABOUT_BODY: 'Meowfia هي سلوت بـ 5 بكرات و4 صفوف و20 خط دفع. تُدفع الأرباح من اليسار إلى اليمين على البكرات المجاورة، بدءًا من أقصى اليسار. يلزم 3 رموز متطابقة على الأقل لكل خط. يُدفع أعلى ربح فقط لكل خط. في اللعبة الأساسية، قد تُفعّل عملات Paw أو Super Wild في لفة واحدة، لكن ليس كلاهما في نفس اللفة. احصل على 3+ رموز Bonus لدخول اللفات المجانية واختر هدفًا لـ 8 أو 10 أو 12 لفة.',
