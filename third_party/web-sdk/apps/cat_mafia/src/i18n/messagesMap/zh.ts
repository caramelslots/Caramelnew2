export default {
	...
	DUEL_INTRO_RULE_1: '猫有 10 次旋转',
	DUEL_INTRO_RULE_2: '狗有 10 次旋转',
	DUEL_INTRO_RULE_3: '孤注一掷！',
	DUEL_OUTRO_LOSS_TITLE: '你输了',
	DUEL_OUTRO_LOSS_ENEMY: '对手银行',
	DUEL_OUTRO_LOSS_YOU: '你的银行',
	DUEL_INTRO_YOUR_SIDE: '你的一方：{side}',
	DUEL_SIDE_CAT: '猫',
	DUEL_SIDE_DOG: '狗',
	DUEL_PICK_TITLE: '选择你的阵营',
	DUEL_CAT_SHORT_DESC: '均势',
	DUEL_DOG_SHORT_DESC: '高波动',
	DUEL_CAT_LONG_DESC: '10次旋转——更高奖金赢得双方',
	DUEL_DOG_LONG_DESC: '10次旋转——更高奖金赢得双方',
	BUY_NORMAL_COST: '×100',
	BUY_SUPER_COST: '×200',
	...
	GAME_INFO_ABOUT_BODY: 'Meowfia 是一款 5 轴 4 行、20 条支付线的老虎机。奖金从最左轴开始在相邻轴上从左到右支付。每条线至少需要 3 个相同符号才能赢奖。每条线只支付最高赢奖。在基础游戏中，Paw 金币和 Super Wild 可在一次旋转中触发，但同一旋转不会同时触发。收集 3 个或更多 Bonus 符号进入免费旋转，并选择目标获得 8、10 或 12 次免费旋转。',
