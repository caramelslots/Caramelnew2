export default {
	...
	DUEL_INTRO_RULE_1: '고양이는 10번의 스핀',
	DUEL_INTRO_RULE_2: '개는 10번의 스핀',
	DUEL_INTRO_RULE_3: '올 오어 나씽!',
	DUEL_OUTRO_LOSS_TITLE: '패배했습니다',
	DUEL_OUTRO_LOSS_ENEMY: '상대 뱅크',
	DUEL_OUTRO_LOSS_YOU: '내 뱅크',
	DUEL_INTRO_YOUR_SIDE: '당신의 편: {side}',
	DUEL_SIDE_CAT: '고양이',
	DUEL_SIDE_DOG: '개',
	DUEL_PICK_TITLE: '진영을 선택하세요',
	DUEL_CAT_SHORT_DESC: '균형',
	DUEL_DOG_SHORT_DESC: '고변동',
	DUEL_CAT_LONG_DESC: '10스핀 — 더 높은 뱅크가 둘 다 획득',
	DUEL_DOG_LONG_DESC: '10스핀 — 더 높은 뱅크가 둘 다 획득',
	BUY_NORMAL_COST: '×100',
	BUY_SUPER_COST: '×200',
	...
	GAME_INFO_ABOUT_BODY: 'Meowfia는 5릴 4행 20페이라인 슬롯입니다. 당첨금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 지급됩니다. 라인당 최소 3개의 일치 심볼이 필요합니다. 라인당 가장 높은 당첨금만 지급됩니다. 기본 게임에서 Paw 코인과 Super Wild가 스핀에 발동할 수 있지만 같은 스핀에서 둘 다는 불가합니다. Bonus 심볼 3개 이상으로 프리 스핀에 진입해 8, 10, 12 프리 스핀 목표를 선택하세요.',
