export default {
	...
	DUEL_BONUS: 'DUEL',
	DUEL_INTRO_RULE_1: 'PICK CAT OR DOG — YOU FIGHT FOR THAT SIDE',
	DUEL_INTRO_YOUR_SIDE: 'YOU PLAY AS {side}',
	DUEL_SIDE_CAT: 'CAT',
	DUEL_SIDE_DOG: 'DOG',
	DUEL_INTRO_RULE_2: 'TWO BOARDS SPIN · {n} SPINS EACH',
	DUEL_INTRO_RULE_3: 'HIGHEST TOTAL WINS — TAKE BOTH BANKS IF YOU BEAT THE OTHER SIDE',
	DUEL_PICK_TITLE: 'CHOOSE YOUR SIDE',
	DUEL_CAT_SHORT_DESC: '~50% WIN RATE',
	DUEL_DOG_SHORT_DESC: 'HIGH VOLATILITY',
	DUEL_CAT_LONG_DESC:
		'PLAY AS CAT — ABOUT HALF OF DUELS END IN YOUR FAVOUR. STEADY WINS WHEN YOU BEAT THE DOG.',
	DUEL_DOG_LONG_DESC:
		'PLAY AS DOG — FEWER WINS, BUT BIGGER PAYOUTS WHEN YOU FINISH AHEAD OF THE CAT.',
	BUY_NORMAL_COST: '×100',
	BUY_SUPER_COST: '×200',
	BUY_DUEL_COST: '×150',
	...
	BUY_DUEL_DESC_SPINS: 'DUEL SPINS',
	BUY_DUEL_DESC_FEATURE: 'Pick Cat or Dog · your side wins both banks',
	BUY_CONFIRM: 'BUY',
	BUY_CANCEL: 'BACK',
	...
	TARGET_SHOOT_HINT_INTRO: 'Get ready…',
	TARGET_SHOOT_HINT_PICK: 'Pick a target!',
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Wok Fury is a 5-reel, 5-row slot with 25 winlines. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel. A minimum of 3 matching symbols on a winline is required for a prize. Only the highest prize per line is awarded.',
	GAME_INFO_PAYLINES_TITLE_SOCIAL: 'WINLINES (25)',
	GAME_INFO_PAYLINES_NOTE_SOCIAL: 'All 25 winlines are always active. Prizes are awarded from left to right on adjacent reels, starting from the leftmost reel. A minimum of 3 matching symbols on adjacent reels is required to create a valid winning line.',
