export default {
	...
	GAME_INFO_ABOUT_BODY: 'Meowfia é um slot de 5 rolos e 4 filas com 20 linhas de pagamento. Os prémios pagam da esquerda para a direita em rolos adjacentes, a partir do rolo mais à esquerda. São necessários pelo menos 3 símbolos iguais numa linha para ganhar. Só é pago o prémio mais alto por linha. No jogo base, moedas Paw e Super Wild podem ativar num giro, mas nunca ambos no mesmo giro. Obtenha 3 ou mais símbolos Bonus para entrar em rodadas grátis e escolha um alvo para 8, 10 ou 12 rodadas grátis.',
