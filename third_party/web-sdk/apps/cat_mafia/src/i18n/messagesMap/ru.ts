export default {
	...
	DUEL_INTRO_RULE_1: 'У кота — 10 спинов',
	DUEL_INTRO_RULE_2: 'У собаки — 10 спинов',
	DUEL_INTRO_RULE_3: 'Всё или ничего!',
	DUEL_OUTRO_LOSS_TITLE: 'Вы проиграли',
	DUEL_OUTRO_LOSS_ENEMY: 'Банк противника',
	DUEL_OUTRO_LOSS_YOU: 'Ваш банк',
	DUEL_INTRO_YOUR_SIDE: 'Ваша сторона: {side}',
	DUEL_SIDE_CAT: 'Кот',
	DUEL_SIDE_DOG: 'Собака',
	DUEL_BANK_TOTAL: 'ИТОГО',
	DUEL_BANK_TOTAL_SOCIAL: 'ИТОГО',
	DUEL_PICK_TITLE: 'ВЫБЕРИ СТОРОНУ',
	DUEL_PICK_BLURB: 'Выбери сторону и играй за персонажа. Крутятся две доски - больший банк забирает оба.',
	DUEL_CAT_SHORT_DESC: 'РАВНЫЕ',
	DUEL_DOG_SHORT_DESC: 'ВЫСОКИЙ РИСК',
	DUEL_CAT_LONG_DESC: 'Равные шансы · ниже среднего',
	DUEL_DOG_LONG_DESC: 'Высокий риск · крупные выигрыши',
	BUY_NORMAL_COST: '×100',
	BUY_SUPER_COST: '×200',
