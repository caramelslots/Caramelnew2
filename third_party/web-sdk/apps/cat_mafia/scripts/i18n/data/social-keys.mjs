...
const ar = {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Meowfia هي سلوت بـ 5 بكرات و4 صفوف و20 prize. تُدفع الأرباح من اليسار إلى اليمين على البكرات المجاورة، بدءًا من أقصى اليسار. يلزم 3 رموز متطابقة على الأقل لكل خط. يُدفع أعلى ربح فقط لكل خط. في اللعبة الأساسية، قد تُفعّل عملات Paw أو Super Wild في لفة واحدة، لكن ليس كلاهما في نفس اللفة. احصل على 3+ رموز Bonus لدخول اللفات المجانية واختر هدفًا لـ 8 أو 10 أو 12 لفة.',
...
const hi = {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Meowfia एक 5-रील, 4-पंक्ति स्लॉट है जिसमें 20 prize हैं। जीत बाएँ से दाएँ सAdjacent रीलों पर, सबसे बाएँ रील से शुरू होकर भुगतान होती है। एक लाइन पर जीत के लिए कम से कम 3 मेल खाते सिंबल चाहिए। प्रति लाइन केवल सबसे अधिक जीत भुगतान होती है। बेस गेम में Paw सिक्के और Super Wild एक स्पिन में ट्रिगर हो सकते हैं, लेकिन एक ही स्पिन में दोनों कभी नहीं। 3+ Bonus सिंबल लैंड करें, 8, 10 या 12 फ्री स्पिन के लिए लक्ष्य चुनें।',
...
const ja = {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Meowfiaは5リール4段の20賞金ラインスロットです。賞金は最左リールから隣接リール上で左から右に付与われます。ライン上に最低3つの一致シンボルが必要です。各ラインで最も高い賞金のみが付与われます。ベースゲームではPawコインとSuper Wildがスピンで発動することがありますが、同じスピンで両方は発動しません。Bonusシンボル3つ以上でフリースピンに入り、8、10、12フリースピンのターゲットを選びます。',
...
const ko = {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Meowfia는 5릴 4행 20상금 라인 슬롯입니다. 상금금은 가장 왼쪽 릴부터 인접 릴에서 왼쪽에서 오른쪽으로 부여됩니다. 라인당 최소 3개의 일치 심볼이 필요합니다. 라인당 가장 높은 상금금만 부여됩니다. 기본 게임에서 Paw 코인과 Super Wild가 스핀에 발동할 수 있지만 같은 스핀에서 둘 다는 불가합니다. Bonus 심볼 3개 이상으로 프리 스핀에 진입해 8, 10, 12 프리 스핀 목표를 선택하세요.',
...
const zh = {
	...
	GAME_INFO_ABOUT_BODY_SOCIAL: 'Meowfia 是一款 5 轴 4 行、20 条奖励线的老虎机。奖金从最左轴开始在相邻轴上从左到右发放。每条线至少需要 3 个相同符号才能奖励。每条线只发放最高奖励。在基础游戏中，Paw 金币和 Super Wild 可在一次旋转中触发，但同一旋转不会同时触发。收集 3 个或更多 Bonus 符号进入免费旋转，并选择目标获得 8、10 或 12 次免费旋转。',
